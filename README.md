...
<table>
  ...
  <tr>
    <td><img src=".docs/images/all-v0.1.2-en.png" width="240" alt="All: learning, research, and leisure in one vault"></td>
    <td><img src=".docs/images/subvault-v0.1.2-en.png" width="240" alt="Research subvault with an open file from Learning"></td>
    <td><img src=".docs/images/create-v0.1.2-en.png" width="240" alt="Creating a Leisure subvault with an orange gamepad icon"></td>
  </tr>
</table>
